...
export default function AdminInventoryPage() {
	...
	const handleAddProduct = () => {
		...
		localStorage.setItem("inventory", JSON.stringify([...products, newProduct]))
	}
	...
	const openEditDialog = (product: any) => {
		...
		setFormData({
			...
			price15Days: product.price15Days ? product.price15Days.toString() : "",
			price2Days: product.price2Days ? product.price2Days.toString() : "",
